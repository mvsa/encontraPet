...
export default function NewAdoption({navigation}){
    ...
    return(
        ...
        <ScrollView style={styles.container}>
            <View style={styles.formArea}>
                ...
                <View style={styles.inputArea}>
                    <Text style={styles.pickerPlaceholder}>
                        Descreva da melhor forma o animal:
                    </Text>
                    <Input style = {styles.input}
                        containerStyle = {{paddingHorizontal:0, marginBottom:-20 }}
                        inputContainerStyle={{borderBottomWidth:0,}}
                ...
                <View style={styles.inputArea}>
                    ...
                    <View style = {styles.pickerArea}>
                        ...
                        <Picker
                            ...
                            <Picker.Item style={styles.item} label="Não sei" value="1" />
                            <Picker.Item style={styles.item} label="1 a 6 meses" value="2" />
                            <Picker.Item style={styles.item} label="6 meses a 1 ano" value="3" />
                            <Picker.Item style={styles.item} label="1 a 2 anos" value="4" />
                            <Picker.Item style={styles.item} label="2 a 4 anos" value="5" />
                            <Picker.Item style={styles.item} label="5 anos ou mais" value="6" />
                        </Picker>
                        </View>
                    </View> 
