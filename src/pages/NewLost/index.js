...
export default function NewLost({navigation}){
        ...
        <ScrollView style={styles.container}>
            <View style={styles.formArea}>
                <Text style={styles.title}>
                    Preencha os dados do Pet perdido:
                </Text>
                ...
                <View style={styles.inputArea}>
                    <Text style={styles.pickerPlaceholder}>
                        Descreva da melhor forma seu Pet. Onde ele foi perdido? Quais características únicas ele possui? Quanto mais informações melhor:
                    </Text>
                    <Input style = {styles.input}
                        containerStyle = {{paddingHorizontal:0, marginBottom:-20 }}
                        inputContainerStyle={{borderBottomWidth:0,}}
                ...
                <View style={styles.inputArea}>
                    <Text style={styles.pickerPlaceholder}>
                            Onde o animal foi visto pela última vez?
                        </Text>
